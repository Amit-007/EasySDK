...
extension Date {
    ...
    /// Returns current date from the start of Date
    public static var current: Date {
        return Calendar.current.startOfDay(for: Date())
    }
    
    /// Returns currenr instance of Date
    public var now: Date {
        return Date()
    }
    ...
    /// End of week with daylight saving time
    ...
    /// EasySDK: returns current Calendar instance
    ...
    /// EasySDK: Check if date is in future.
    ///
    ...
    /// EasySDK: Check if date is in past.
    ///
    ...
    /// EasySDK: Check if date is within today.
    ///
    ///     Date().isInToday -> true
    ///
   public  var isInToday: Bool {
    ...
    /// EasySDK: Check if date is within yesterday.
    ///
    ...
    /// EasySDK: Check if date is within tomorrow.
    ///
    ...
    /// EasySDK: Check if date is within a weekend period.
    public var isInWeekend: Bool {
        return calendar.isDateInWeekend(self)
    }
    
    /// EasySDK: Check if date is within a weekday period.
    public var isWorkday: Bool {
        return !calendar.isDateInWeekend(self)
    }
    
    /// EasySDK: Check if date is within the current week.
    public var isInCurrentWeek: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .weekOfYear)
    }
    
    /// EasySDK: Check if date is within the current month.
    public var isInCurrentMonth: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .month)
    }
    
    /// EasySDK: Check if date is within the current year.
    public var isInCurrentYear: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .year)
    }
    
    /// EasySDK: ISO8601 string of format (yyyy-MM-dd'T'HH:mm:ss.SSS) from date.
    ///
    ...
    /// EasySDK: Nearest five minutes to date.
    ///
    ...
    /// EasySDK: Nearest ten minutes to date.
    ///
    ...
    /// EasySDK: Nearest quarter hour to date.
    ///
    ///     var date = Date() // "5:57 PM"
    ///     date.minute = 34 // "5:34 PM"
    ...
    /// EasySDK: Nearest half hour to date.
    ///
    ...
    /// EasySDK: UNIX timestamp from date.
    ///
...
public extension Date {
    ...
    /// EasySDK: Date by adding multiples of calendar component.
    ///
    ...
    /// EasySDK: Add calendar component to date.
    ///
    ...
    /// EasySDK: Date by changing value of calendar component.
    ///
    ///     let date = Date() // "Jan 12, 2017, 7:07 PM"
    ...
    /// EasySDK: Data at the beginning of calendar component.
    ///
    ...
    /// EasySDK: Date at the end of calendar component.
    ///
    ...
    /// EasySDK: Check if date is in current given calendar component.
    ///
    ...
    /// EasySDK: Date and time string from date.
    ///
    ...
    /// EasySDK: get number of seconds between two date
    ///
    ...
    /// EasySDK: get number of minutes between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// EasySDK: get number of hours between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// EasySDK: get number of days between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// EasySDK: check if a date is between two other dates
    ///
    /// - Parameters:
    ...
    /// EasySDK: check if a date is a number of date components of another date
    ///
    /// - Parameters:
    ...
    /// EasySDK: Returns a random date within the specified range.
    ///
    ...
    /// EasySDK: Returns a random date within the specified range, using the given generator as a source for randomness.
    ///
    /// - Parameters:
    ...
    /// EasySDK: method returns a custom date
    ///
    /// - Parameters:
...
public extension Date {
    ...
    /// EasySDK: Create a new date form calendar components.
    ///
    ...
    /// EasySDK: Create date object from ISO8601 string.
    ///
    ...
    /// EasySDK: Create new date object from UNIX timestamp.
    ///
    ...
    /// EasySDK: Create date object from Int literal
    ///
