...
public extension Int {
    ...
    /// EasySDK: String formatted for values over ±1000 (example: 1k, -2k, 100k, 1kk, -5kk..)
    ...
    /// EasySDK: Array of digits of integer value.
    var digits: [Int] {
    ...
    /// EasySDK: Number of digits of integer value.
    var digitsCount: Int {
...
public extension Int {
    ...
    /// EasySDK: check if given integer prime or not.
    ...
    /// EasySDK: Roman numeral string from integer (if applicable).
    ///
    ///10.romanNumeral() -> "X"
    ///
    ...
    /// EasySDK: Rounds to the closest multiple of n
...
prefix operator √
/// EasySDK: Square root of integer.
///
