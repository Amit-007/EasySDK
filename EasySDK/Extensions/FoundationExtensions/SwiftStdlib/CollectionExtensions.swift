...
public extension Collection {
    ...
    #if canImport(Dispatch)
    /// EasySDK: Performs `each` closure for each element of collection in parallel.
    ///
    ...
    /// EasySDK: Safe protects the array from out of bounds by use of optional.
    ///
    ///        let arr = [1, 2, 3, 4, 5]
    ///        arr[safe: 1] -> 2
    ///        arr[safe: 10] -> nil
...
public extension Collection where Index == Int {
    ...
    /// EasySDK: Get all indices where condition is met.
    ///
    ...
    /// EasySDK: Calls the given closure with an array of size of the parameter slice.
    ///
    ...
    /// EasySDK: Returns an array of slices of length "size" from the array. If array can't be split evenly, the final slice will be the remaining elements.
    ///
...
public extension Collection where Element == IntegerLiteralType, Index == Int {
    ...
    /// EasySDK: Average of all elements in array.
    ///
