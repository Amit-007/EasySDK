...
public extension Array {
    ...
    /// EasySDK: Insert an element at the beginning of array.
    ///
    ...
    /// EasySDK: Safely swap values at given index positions.
    ///
    ...
    /// EasySDK: Separates array into 2 arrays based on a given predicate.
    ///
    ...
    /// EasySDK: Returns a sorted array based on an optional keypath.
    ///
    ...
    /// EasySDK: Returns a sorted array based on a keypath.
    ///
    /// - Parameter path: Key path to sort. The key path type must be Comparable.
    /// - Parameter ascending: If order must be ascending.
    /// - Returns: Sorted array based on keyPath.
    ...
    /// EasySDK: Sort the array based on an optional keypath.
    ///
    /// - Parameters:
    ...
    /// EasySDK: Sort the array based on a keypath.
    ///
    /// - Parameters:
    ///   - path: Key path to sort, must be Comparable.
    ///   - ascending: whether order is ascending or not.
...
public extension Array where Element: Equatable {
    ...
    /// EasySDK: Remove all instances of an item from array.
    ///
    ...
    /// EasySDK: Remove all instances contained in items parameter from array.
    ///
    ...
    /// EasySDK: Remove all duplicate elements from Array.
    ///
    ...
    /// EasySDK: Return array with all duplicate elements removed.
    ///
