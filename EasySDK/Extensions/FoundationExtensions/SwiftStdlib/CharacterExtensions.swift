...
public extension Character {
    ...
    /// EasySDK: Check if character is emoji.
    ///
    ...
    /// EasySDK: Integer from character (if applicable).
    ///
    ///        Character("1").int -> 1
    ///        Character("A").int -> nil
    ///
    ...
    /// EasySDK: Return the character lowercased.
    ///
    ...
    /// EasySDK: Return the character uppercased.
    ///
...
public extension Character {
    ...
    /// EasySDK: Repeat character multiple times.
    ///
    ///        Character("-") * 10 -> "----------"
    ///
    /// - Parameters:
