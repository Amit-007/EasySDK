...
public extension SignedInteger {
    ...
    /// EasySDK: Absolute value of integer number.
    var abs: Self {
        return Swift.abs(self)
    }

    /// EasySDK: Check if integer is positive.
    var isPositive: Bool {
        return self > 0
    }

    /// EasySDK: Check if integer is negative.
    var isNegative: Bool {
        return self < 0
    }

    /// EasySDK: Check if integer is even.
    var isEven: Bool {
        return (self % 2) == 0
    }

    /// EasySDK: Check if integer is odd.
    var isOdd: Bool {
        return (self % 2) != 0
    }

    /// EasySDK: String of format (XXh XXm) from seconds Int.
...
public extension SignedInteger {
    ...
    /// EasySDK: Greatest common divisor of integer value and n.
    ///
    ...
    /// EasySDK: Least common multiple of integer and n.
    ///
    ...
    #if canImport(Foundation)
    /// EasySDK: Ordinal representation of an integer.
    ///
