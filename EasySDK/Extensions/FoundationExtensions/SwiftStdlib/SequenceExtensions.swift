...
public extension Sequence {
    ...
    /// EasySDK: Check if all elements in collection match a conditon.
    ///
    ...
    /// EasySDK: Check if no elements in collection match a conditon.
    ///
    ...
    /// EasySDK: Check if any element in collection match a conditon.
    ///
    ...
    /// EasySDK: Get last element that satisfies a conditon.
    ///
    ...
    /// EasySDK: Filter elements based on a rejection condition.
    ///
    ...
    /// EasySDK: Get element count based on condition.
    ///
    ...
    /// EasySDK: Iterate over a collection in reverse order. (right to left)
    ///
    ...
    /// EasySDK: Calls the given closure with each element where condition is true.
    ///
    ...
    /// EasySDK: Reduces an array while returning each interim combination.
    ///
    ...
    /// EasySDK: Filtered and map in a single operation.
    ///
    ...
    /// EasySDK: Get the only element based on a condition.
    ///
    ...
    /// EasySDK: Remove duplicate elements based on condition.
    ///
...
public extension Sequence where Element: Equatable {
    ...
    /// EasySDK: Check if array contains an array of elements.
    ///
...
public extension Sequence where Element: Hashable {
    ...
    /// EasySDK: Check whether a sequence contains duplicates.
    ///
    ...
    /// EasySDK: Getting the duplicated elements in a sequence.
    ///
...
public extension Sequence where Element: Numeric {
    ...
    /// EasySDK: Sum of all elements in array.
    ///
    ///        [1, 2, 3, 4, 5].sum() -> 15
    ///
