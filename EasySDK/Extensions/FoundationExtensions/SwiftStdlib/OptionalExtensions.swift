...
public extension Optional {
    ...
    /// EasySDK: Get self of default value (if self is nil).
    ///
    ///		let foo: String? = nil
    ...
    /// EasySDK: Gets the wrapped value of an optional. If the optional is `nil`, throw a custom error.
    ///
    ///        let foo: String? = nil
    ...
    /// EasySDK: Runs a block to Wrapped if not nil
    ///
    ///		let foo: String? = nil
    ...
    /// EasySDK: Assign an optional value to a variable only if the value is not nil.
    ///
    ...
    /// EasySDK: Assign an optional value to a variable only if the variable is nil.
    ///
...
public extension Optional where Wrapped: Collection {
    ...
    /// EasySDK: Check if optional is nil or empty collection.
    var isNilOrEmpty: Bool {
        guard let collection = self else { return true }
        return collection.isEmpty
    }

    /// EasySDK: Returns the collection only if it is not nill and not empty.
