...
public extension Dictionary {
    ...
    /// EasySDK: Check if key exists in dictionary.
    ///
    ...
    /// EasySDK: Remove all keys contained in the keys parameter from the dictionary.
    ///
    ...
    /// EasySDK: Remove a value for a random key from the dictionary.
    @discardableResult
    ...
    #if canImport(Foundation)
    /// EasySDK: JSON Data from dictionary.
    ///
    ...
    #if canImport(Foundation)
    /// EasySDK: JSON String from dictionary.
    ///
    ...
    /// EasySDK: Returns a dictionary containing the results of mapping the given closure over the sequence’s elements.
    ...
    /// EasySDK: Returns a dictionary containing the non-`nil` results of calling the given transformation with each element of this sequence.
...
public extension Dictionary where Value: Equatable {
    ...
    /// EasySDK: Returns an array of all keys that have the given value in dictionary.
    ///
...
public extension Dictionary where Key: StringProtocol {
    ...
    /// EasySDK: Lowercase all keys in dictionary.
    ///
...
public extension Dictionary {
    ...
    /// EasySDK: Deep fetch or set a value from nested dictionaries.
    ///
...
public extension Dictionary {
    ...
    /// EasySDK: Merge the keys/values of two dictionaries.
    ///
    ...
    /// EasySDK: Append the keys and values from the second dictionary into the first one.
    ///
    ...
    /// EasySDK: Remove keys contained in the sequence from the dictionary
    ///
