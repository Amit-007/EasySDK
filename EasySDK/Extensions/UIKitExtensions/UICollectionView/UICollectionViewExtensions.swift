...
public extension UICollectionView {
    ...
    /// EasySDK: Index path of last item in collectionView.
    var indexPathForLastItem: IndexPath? {
        return indexPathForLastItem(inSection: lastSection)
    }

    /// EasySDK: Index of last section in collectionView.
    var lastSection: Int {
...
public extension UICollectionView {
    ...
    /// EasySDK: Number of all items in all sections of collectionView.
    ///
    ...
    /// EasySDK: IndexPath for last item in section.
    ///
    ...
    /// EasySDK: Reload data with a completion handler.
    ///
    ...
    /// EasySDK: Dequeue reusable UICollectionViewCell using class name.
    ///
    /// - Parameters:
    ...
    /// EasySDK: Dequeue reusable UICollectionReusableView using class name.
    ///
    /// - Parameters:
    ...
    /// EasySDK: Register UICollectionReusableView using class name.
    ///
    /// - Parameters:
    ///   - kind: the kind of supplementary view to retrieve. This value is defined by the layout object.
    ///   - name: UICollectionReusableView type.
    ...
    /// EasySDK: Register UICollectionViewCell using class name.
    ///
    /// - Parameters:
    ...
    /// EasySDK: Register UICollectionViewCell with .xib file using only its corresponding class.
    ...
    /// EasySDK: Check whether IndexPath is valid within the CollectionView
    ///
