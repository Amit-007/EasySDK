...
public extension UIView {
    ...
    /**
     ...
     - completion: block executed when the animation ends
     */
    @discardableResult func bounceOut(to edge: AnimationEdge = .none,
                                      x: CGFloat = 0,
                                      y: CGFloat = 0,
    ...
    /**
     ...
     - completion: block executed when the animation ends
     */
    @discardableResult func hop(toward edge: AnimationEdge = .none,
                                amount: CGFloat = 0.4,
    ...
    /**
     ...
     - completion: block executed when the animation ends
     */
    @discardableResult func shake(toward edge: AnimationEdge = .none,
                                  amount: CGFloat = 0.15,
                                  duration: TimeInterval = 0.6,
                                  delay: TimeInterval = 0,
                                  completion: ((Bool) -> Void)? = nil) -> UIView {
