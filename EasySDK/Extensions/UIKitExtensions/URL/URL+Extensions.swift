...
public extension URL {
    ...
    /// EasySDK: Dictionary of the URL's query parameters
...
public extension URL {
    ...
    /// EasySDK: URL with appending query parameters.
    ///
    ///		let url = URL(string: "https://google.com")!
    ///		let param = ["q": "Swift SDK"]
    ///		url.appendingQueryParameters(params) -> "https://google.com?q=Swift%20SDK"
    ///
    ...
    /// EasySDK: Append query parameters to URL.
    ///
    ///		var url = URL(string: "https://google.com")!
    ///		let param = ["q": "Swift SDK"]
    ///		url.appendQueryParameters(params)
    ///		print(url) // prints "https://google.com?q=Swift%20SDK"
    ///
    /// - Parameter parameters: parameters dictionary.
    ...
    /// EasySDK: Get value of a query key.
    ///
    ...
    /// EasySDK: Returns a new URL by removing all the path components.
    ///
    ...
    /// EasySDK: Remove all the path components from the URL.
    ///
    ...
    /// EasySDK: Generates new URL that does not have scheme.
    ///
